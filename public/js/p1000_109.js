...
// project: p1000_109,  UK 1m/30m cutdown version, with FCR
...
function test() {
	...
	*/
	...
	// calculate the second delay to be 30min
	n = new Date(endTime + min30);
	hr = n.getHours();
	...
	*/
	...
	/*
	// calculate the second delayed test target time
