...
function checkAnswer() {
    ...
    if (document.getElementById("tAnswerWord").value.toLocaleLowerCase('tr-TR') === lists[l][i][1]) {
...
function checkNoFeedback() {
    ...
    if (document.getElementById("tAnswerWord").value.toLocaleLowerCase('tr-TR') === tlists[l][i][1]) {
