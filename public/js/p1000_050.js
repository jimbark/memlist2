...
var dL1 = [['taksi','büro',0,0,2,0], ['pamuk','tepsi',0,0,2,0],['gelin','köpük',0,0,2,0]];
...
function test() {
	...
	*/
	...
	// this section commented out as want 24hr format for Italy
	//var ampm = "am";
	//if( hr > 12 ) {
	//    hr -= 12;
	//    ampm = "pm";
...
function checkAnswer() {
    ...
    if (document.getElementById("tAnswerWord").value.toLocaleLowerCase('tr-TR').trim() === lists[l][i][1]) {
...
function checkNoFeedback() {
    ...
    if (document.getElementById("tAnswerWord").value.toLocaleLowerCase('tr-TR').trim() === tlists[l][i][1]) {
